...
<h2><p style="text-align:center ; font-size: 20px ;font-weight:bold; margin-left: -600px;">About the  property</p></h2>
<hr style="width: 900px">

<div class="box-content" >

 <div id="dwellingCode">
        <label><p style="text-align:center ; font-size: 17px ;font-weight:bold;  margin-bottom: 60px;">Room type *</p></label>
...
<div class="form-group" style="margin-right: 50px;">
  <label for="usr"><p style="margin-bottom: -40px;align-content: center; font-weight:bold; margin-right: 240px;">Rent Per Month (Rs) *</p></label>
  <input type="number" name="price" min="1" step="1"  class="form-control" id="rent" style="margin-right: 50px;">
</div>
...
<p style="text-align:center ; font-size: 17px ;font-weight:bold; margin-left: -480px; margin-bottom: -10px;">Facilities</p>
...
<input type="submit" value="Post Your Room" align="center" class="btn btn-primary"/>
</form>
